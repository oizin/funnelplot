...
* Covariate risk adjustment: control for differences in the characteristics of observations within each cluster. This is done through using a statistical model to calculate $\hat{y}_{ij}$, an estimate of the expected outcome for each observation, and cluster level comparison of the observed and expected outcomes.  
* Multiplicity adjustment: control for potentially high false positive rates in the comparison of large numbers of clusters.   
